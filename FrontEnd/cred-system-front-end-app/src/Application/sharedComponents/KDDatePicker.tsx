...
import { isNotExpired, isNotFutureDate, isOver18 } from "../utils/helperMethods";
...
const KDDatePicker =({pickerId, pickerLabel, required, onHandleChange, errorHandler, 
    register, value, validationType, optionalMessage}:KDDatePickerProps) => {
            ...
            <div className={errorHandler[pickerId] && "usa-form-group usa-form-group--error"}>
                ...
                <div style={{width: "320px"}}>
                    <DatePicker
                        ...
                        aria-invalid={required ? errorHandler[pickerId] ? "true" : "false" : "false"}
                        defaultValue={value}
