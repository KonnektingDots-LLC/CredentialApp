...
import InviteForm from '../../Presentation/Pages/ProviderDelegates/InviteDelegates/inviteForm';
...
const InviteDelegateModal = ({closeModal}:Props)=>{
        ...
        <Modal closeModal={closeModal}>
            {step === 1 ? 
                ...
                <div className="flex flex-col gap-3 p-6 w-94">
                    ...
                    <p className="text-ink ml-8">Your invitation is sent. Please check your email.</p>
...
export default InviteDelegateModal;
