...
const AdminWelcome = () => {
  ...
  const [providerList, setProviderList] = useState<ProvidersList[] | undefined>(undefined);
...
const handleOnPreviousPage = async () => {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      const response = await getInsurerProviderList(api, currentPage, limitPerPage);
    ...
    <section>
      ...
      <div id="content">
        <div className=" flex">
            ...
            <Blurb title="Key Information">
              <ul className=" flex flex-col gap-2">
                ...
                <li className=" list-disc">
                  ...
                  <a className="usa-link cursor-pointer" onClick={() => navigate('/glossary')}>Learn More here</a>.
                </li>
              </ul>
            </Blurb>
          ...
          <div className=" w-6/12">
            <img className=" block" src={IMAGES.providerWelcome}></img>
          </div>
        </div>
        <div className=" w-4/6">
        {providerList?.length ? (
